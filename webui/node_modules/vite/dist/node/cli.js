...
import { y as picocolors, u as createLogger, e as resolveConfig } from 'vite/dist/node/chunks/dep-0fc8e132.js';
...
cli
    ...
    // is ok here
    const { createServer } = await import('vite/dist/node/chunks/dep-0fc8e132.js').then(function (n) { return n.E; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    const { build } = await import('vite/dist/node/chunks/dep-0fc8e132.js').then(function (n) { return n.D; });
...
cli
    ...
    .option('--force', `[boolean] force the optimizer to ignore the cache and re-bundle`)
    .action(async (root, options) => {
    const { optimizeDeps } = await import('vite/dist/node/chunks/dep-0fc8e132.js').then(function (n) { return n.C; });
    try {
...
cli
    ...
    .option('--open [path]', `[boolean | string] open browser on startup`)
    .action(async (root, options) => {
    const { preview } = await import('vite/dist/node/chunks/dep-0fc8e132.js').then(function (n) { return n.F; });
    try {
